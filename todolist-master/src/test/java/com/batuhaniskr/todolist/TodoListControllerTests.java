package com.batuhaniskr.todolist;
...
public class TodoListControllerTests {
    ...
    public void setup() {
        SecurityContextHolder.getContext().setAuthentication(
                new UsernamePasswordAuthenticationToken("batuhaniskr@gmail.com", "123456"));
    }
    ...
    @Test
    @WithUserDetails("batuhaniskr@gmail.com")
    public void testCreateTodoList() throws Exception {
        User user = new User();
        user.setEmail("batuhaniskr@gmail.com");
        user.setId(1L);
